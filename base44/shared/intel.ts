...
export const DEFAULT_SOURCES = [
  ...
  },
  {
    ...
    description: 'Leak and vulnerability announcements tracked from a public Telegram channel handle.',
    license_note: 'Set telegram_channel on the source or use the TELEGRAM_CHANNEL fallback. Respect Telegram terms and keep polling light.',
    requires_secret: 'TELEGRAM_CHANNEL',
